...
namespace UniDAQ_Ns
{
    ...
    public class UniDAQ
    {
        ...
        [DllImport("UniDAQ.dll")]
        public static extern UInt16 Ixud_SetFCChannelMode(UInt16 wBoardNo, UInt16 wChannelNo,UInt16 wMode,UInt16 wDelayMs);

        [DllImport("UniDAQ.dll")]
        public static extern UInt16 Ixud_ReadFrequency(UInt16 wBoardNo, UInt16 wChannelNo,ref Single fFrequency, UInt32 dwTimeOutMs,ref UInt16 wStatus);
